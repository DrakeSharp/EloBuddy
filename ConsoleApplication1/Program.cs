...
{
    internal static class BackPropProgram
    {
        private static void Main()
        {
            ...
            const int seed = 1; // gives nice demo
        ...
        private static double[][] MakeAllData(int numInput, int numHidden,
        ...
        private static void SplitTrainTest(double[][] allData, double trainPct,
    ...
    {
        private readonly int numInput; // number input nodes
            ...
            double learnRate, double momentum)
        {
            ...
            while (epoch < maxEpochs)
            {
                ...
                for (int ii = 0; ii < trainData.Length; ++ii)
                {
                    ...
                    {
                        var errorSignal = tValues[k] - outputs[k];

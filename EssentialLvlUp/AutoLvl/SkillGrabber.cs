...
namespace EssentialLvlUp.AutoLvl
{
    internal class SkillGrabber
    {
        ...
        public void UpdateBuilds(bool[] locked = null)
        {
            ...
            bw.ProgressChanged +=
                delegate(object o, ProgressChangedEventArgs args) { status = args.UserState.ToString(); };
        ...
        private static string[] getBestBuildLink(string champLink)
        {
            ...
            ret[0] = champLink.Substring(champLink.LastIndexOf("/") + 1,
                champLink.LastIndexOf("-") - (champLink.LastIndexOf("/") + 1));
